    ...
    return (
      <footer className="bg-[#067627] text-white p-4 text-center">
        <div className="container mx-auto flex flex-col justify-between items-center">
          ...
          <p className="text-sm">Copyright © 2024 Yap Leather Studio. All rights reserved.</p>
          <p className="text-sm">4 Deerfield Dr, Nepean, Ottawa, Ontario</p>
          <p className="text-sm">Email: yapeng@yapleather.com</p>
          <p className="text-sm">Phone: Phone: 613-863-0315</p>
        </div>
      </footer>
    );
  }